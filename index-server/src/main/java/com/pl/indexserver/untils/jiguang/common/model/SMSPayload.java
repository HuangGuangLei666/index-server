package com.pl.indexserver.untils.jiguang.common.model;
...
public class SMSPayload implements IModel {
    ...
    private SMSPayload(String mobileNumber, int signId, int tempId, int ttl, String code, int voiceLang, String phonenumber, Map<String, String> temp_para) {
    ...
    public static class Builder {
        ...
        public SMSPayload build() {
            ...
            return new SMSPayload(mobile, sign_id, temp_id, ttl, code, voice_lang,phonenumber, tempParaBuilder);
        }
    }
